...
## Project Structure
    ...
    ├── weathered_meadow_de_82068  # Django project configurations
...
1. Clone this repo and `cd weathered_meadow_de_82068`
...
2. Clone this repo and `cd weathered_meadow_de_82068`
